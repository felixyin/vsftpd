...
/**
 * ftp工具类 2020年8月5日11:53:20 author ： felixyin
 */
@Component
public class FtpUtil {
    ...
    public FTPClient getFtpClient() {
        ...
        try {
            ...
            logger.info("connecting...ftp服务器:" + hostname + ":" + hostname);
            logger.info("connecting...ftp服务器:" + port + ":" + port);
            logger.info("connecting...ftp服务器:" + username + ":" + username);
            logger.info("connecting...ftp服务器:" + password + ":" + password);
